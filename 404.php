...
<body <?php body_class($class); ?>>
    ...
    <div id="main" class="container-fluid">
        <h2 class="center"><?php _e( 'This is somewhat embarrassing, isn’t it?', 'mspecs' ); ?></h2>
        <p class="center"><?php _e( 'It looks like nothing was found at this location. Maybe try a search?', 'mspecs' ); ?></p>
        <div class="row center-xs"><?php get_search_form(); ?></div>
    </div>
    <footer id="colophon">
        <div class="credits">
